...
public class LoginModule extends AbstractOLATModule {
	...
	private static final String FEATURE_LAYOUT_ENABLED = "FeatureLayoutEnabled";
	...
	private static boolean featureLayoutEnabled;
	...
	protected void initDefaultProperties() {
		...
		featureLayoutEnabled = getBooleanConfigParameter(FEATURE_LAYOUT_ENABLED, false);
	...
	public static boolean isFeatureLayoutEnabled() {
		return featureLayoutEnabled;
	}
}
