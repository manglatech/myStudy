...
public class ControllerFactory {
	...
	public static MainLayoutController createLaunchController(OLATResourceable olatResourceable, UserRequest ureq,
		...
		} else if (OresHelper.isOfType(olatResourceable, FinanceAdminMainController.class)) {
			if (!roles.isUserManager()) throw new OLATSecurityException("Tried to launch a FeeMgntAdminMainController, but is not in admin group " + roles);
			return new FinanceAdminMainController(ureq, wControl);
