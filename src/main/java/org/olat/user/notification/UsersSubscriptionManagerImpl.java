...
public class UsersSubscriptionManagerImpl extends UsersSubscriptionManager implements GenericEventListener {
	...
	public List<Identity> getNewIdentityCreated(Date from) {
		return getNewIdentityCreated(from, null);
	}
	@Override
	public List<Identity> getNewIdentityCreated(Date from, String InstituteId) {
		if(from == null)
		...
		List<Identity> guests = manager.getIdentitiesByPowerSearch(null, null, true, null, permissions, null, from, null, null, null, Identity.STATUS_VISIBLE_LIMIT,InstituteId);
		List<Identity> identities = manager.getIdentitiesByPowerSearch(null, null, true, null, null, null, from, null, null, null, Identity.STATUS_VISIBLE_LIMIT,InstituteId);
