...
public class BaseSecurityModule extends AbstractOLATModule {
	...
	private static final String CONFIG_USERMANAGER_ACCESS_TO_PREF = "sysGroupUsermanager.accessToPreferences";
	...
	public static Boolean USERMANAGER_ACCESS_TO_PREF = false;
	...
	protected void initDefaultProperties() {
		...
		USERMANAGER_ACCESS_TO_PREF = getBooleanConfigParameter(CONFIG_USERMANAGER_ACCESS_TO_PREF, USERMANAGER_ACCESS_TO_PREF);
