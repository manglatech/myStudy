...
class FeeFormController extends FormBasicController {
	
	private OLog log = Tracing.createLoggerFor(this.getClass());
	private static final String formIdentifyer = FeeFormController.class.getCanonicalName();
	 ...
	 */
	public FeeFormController(UserRequest ureq, WindowControl wControl, Translator translator) {
		super(ureq, wControl);
