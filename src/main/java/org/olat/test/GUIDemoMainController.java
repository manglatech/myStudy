		...
		if (uobject.equals("guidemo-autocompletion")) {
			...
			ListProvider provider = new ListProvider() {
				public void getResult(String searchValue, String instituteId,  ListReceiver receiver) {
					...
					List<Identity> res = BaseSecurityManager.getInstance().getVisibleIdentitiesByPowerSearch(searchValue, userProperties, false, null, null, null, null, null, instituteId);
					int maxEntries = 15;
